                    ...
                    <form method="post" action="php_recherche_avancee.php"  >
                              ...
                              $link = mysqli_connect($host, $user, $mdp) ;
                               ...
                               mysqli_select_db($link, $bdd) or die("Erreur de connexion à la base de donnée" );
                                ...
                                if ($donnees['typecritere']=="inputradio"){?>
...
<br/><br/>
                                <?php } 
                                           ...
                                           <?php }
                                            ...
                                            else if ($donnees['nomcritere']=="Nombre de chambres"){ ?>

                                           <label for="" class="label" ><?php echo $donnees['nomcritere']; ?></label>
                                                      <select id="chambres" name="chambres" class="select" style="margin: center">
...
<br/><br/>
  ...
  <br/><br/>       <?php }              
                                    ...
                                    <br/><br/>
                                                    <label for="" class="label" ><?php echo $donnees['nomcritere']; ?></label>
                                                    <input type="text" name="<?php echo $donnees['nom'];?>" class="ville"/> personnes
...
<br/><br/>       <?php }            
                        ...
                        <input type="submit" name="Ajouter mon logement" value="rechercher" id="envoyer"class="submit" />
                        </form>
        </fieldset>
